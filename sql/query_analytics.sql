...
FROM 
  ...
  JOIN `uber-project-386415.uber_analysis.passenger_count_dim` p  ON p.passenger_count_id=f.passenger_count_id  
  JOIN `uber-project-386415.uber_analysis.trip_distance_dim` t  ON t.trip_distance_id=f.trip_distance_id  
